...
class Last extends Component {
  ...
  render() { 
    ...
    const { LastTableData } = this.props.state
    const columns =  [
      {
        title: '排名',
    ...
    return (
      ...
      <div className='chartBlock' style={{borderBottom:'1px solid #EEEEEE',marginBottom: '50px'}}>
        <Chart height={400} data={LastTableData.chartData} forceFit>
        ...
        <div className='tableBlock' style={{marginBottom: '20px'}}>
          <Table loading={LastTableData.loading} dataSource={LastTableData.list} columns={columns} pagination={false}/> 
        </div>
