    ...
    handleSubmit = e => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                axios.post('v1/appraise/submitSubStuff', {
                    org_id: this.props.match.params.id,
                    check_year: this.props.match.params.year,
                    sub_project: add_project2,
                    sub_stuff: values.add_detail,
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <Form.Item label="减分项目"  {...formItemLayout} >
                                ...
                                {getFieldDecorator('add_project', {
                                    rules: [{ required: true, message: '请填减分项目' }],
                                    initialValue: "1",
                                })(
                            ...
                            {/* <Form.Item label="减分分值"  {...formItemLayout} >
                                <div class="layout">
                                    {getFieldDecorator('add_score', {
                                        rules: [{ required: true, message: '请填减分分值' }],
                                    })(
