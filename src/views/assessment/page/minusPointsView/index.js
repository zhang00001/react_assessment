...
class bonusEdit extends React.Component {
    ...
    componentDidMount = () => {
        axios.post('v1/appraise/addSubStuffData', { check_year: this.props.match.params.year, org_id: this.props.match.params.id })
            .subscribe(res => {
                this.setState({
                    load: true,
    ...
    handleSubmit = e => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                axios.post('v1/appraise/submitSubScore', {
    ...
    render() {
        ...
        let add_project = data.sub_project || []
                ...
                <div className="selfEdit">
                    <div class="formContent">
                        <Form onSubmit={this.handleSubmit}>
                            <Form.Item label="减分企业"  {...formItemLayout} >
                            ...
                            <Form.Item label="减分详情"  {...formItemLayout} >

                                <TextArea className="text-top" rows={5} value={data.sub_stuff} disabled />
                            ...
                            <Form.Item label="综合减分"  {...formItemLayout} >
                                {getFieldDecorator('sub_score', {
                                    rules: [{ required: true, message: '请填写综合分值' }],
                                })(
                                    <div class="layout">
