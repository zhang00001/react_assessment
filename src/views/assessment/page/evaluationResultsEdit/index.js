...
import { Form, Button, Select, Modal, Input, Upload, message, Icon, InputNumber, Radio } from 'antd';
...
class opinionEdit extends React.Component {
    ...
    componentDidMount = () => {
        axios.post('v1/appraise/resultData', { check_year: this.props.match.params.year, org_id: this.props.match.params.org_id })
            .subscribe(res => {
                this.setState({
                    load: true,
                    data: res.data.data
    ...
    handleSubmit = e => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                axios.post('v1/appraise/resultData', {
                    ...
                    <div class="formContent">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <Form.Item label="初评意见"  {...formItemLayout} >
                                <TextArea className="text-top" rows={5} disabled value={data.preliminary_opinion} />
                            </Form.Item>


                            <Form.Item label="考核结果"  {...formItemLayout} >
                            ...
                            <Form.Item label="考核意见"  {...formItemLayout} >
