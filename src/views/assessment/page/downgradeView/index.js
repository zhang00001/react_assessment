...
class bonusEdit extends React.Component {
    ...
    render() {
        ...
        let add_project = data.down_project || []
                    ...
                    <div class="formContent">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <Form.Item label="党委评估"  {...formItemLayout} >
                                ...
                                <TextArea className="text-top" rows={5} value={data.appraise_content} disabled />

                            </Form.Item>
                            <Form.Item label="降档结果"  {...formItemLayout} >
                                <Select style={{ width: 560 }} value={data.down_result+''} disabled>
