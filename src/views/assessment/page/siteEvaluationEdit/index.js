                    ...
                    <div class="formContent">
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            <Form.Item {...formItemLayout} label="审核结论">
                                {getFieldDecorator('review_result', {
                            ...
                            <Form.Item label="考核分值"  {...formItemLayout} >
                                <div class="layout">
                                    {getFieldDecorator('review_score', {
                                        rules: [{ required: true, message: '请填写考核分值' }],
                                    })(
                            ...
                            <Form.Item label="审核意见"  {...formItemLayout} >
                                {getFieldDecorator('review_suggest', {
